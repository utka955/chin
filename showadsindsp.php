...
<?php
// print "<Br>desc=" . $Desc;
//print "<Br>savedesc=" . $savedesc;
$spacer = "nbsp;";

echo "<tr><td colspan=2><b><p class=listingshead style=\"text-indent: 0px\"><font color=gray>" . $Passcity . "  "  . "</font></b>";
 ...
 while ($MyCount < $number)
    ...
    { 
	     ...
	     $Last = $Lname;
		   ...
		   echo "<tr>";
		   echo "<Td width=160px valign=top>";
		   ...
		   if ($Logo != "")
		   {
		       echo "<img src=listingphotos/$Listingno/$Logo  style=\"margin-top: 15px; width: 140px\">";
                    }	
		  ...
		  echo $Fname . " " . $Lname;
                  echo "<Br><b>Lawyer/</b>"; 
                    echo "<p style=\"margin-top: 5px\"><b>Areas of Practice: </b>";
...
$MyIndex1++;
    ...
    if ($Country == "select state")
     ...
     if ($Country != "select country")
       ...
       echo  " " . $Zip . "<br>";
       echo "<p style=\"margin-top: 10px\"><b>Cities</b><br>";
                echo  $City; 
		If ($City1 != "")
		{
		...
		if ($Orientation != "")
		{
	        ...
	        echo "</td><td width=220px valign=Top>";
		...
		{
		echo "<Tr height=10px><Td colspan=2></td></tr>";
		echo "<tr><Td colspan=2 bgcolor=\"silver\" style=\"color: white; font-weight: bold; margin-top: 5px; padding: 5px 5px 5px 5px; font-size: 14px; letter-spacing: 1px\">Twitter Updates</td></tr>";
		echo "<tr><Td colspan=2 bgcolor=\"white\" style=\"color: black; margin-top: 5px; padding: 5px 5px 5px 5px; font-size: 12px\">";
?>	 	
<div id="twitter_div">

 
<span style="padding-left: 0px; font-size: 12px; font-weight: normal"> 
<ul id="twitter_update_list" style="margin-left: 0px; margin-top: 0px"></ul>
</span>
...
<a name=contact>
<table class="myform" border="0" cellpadding="0" cellspacing="0" align="center" width="80%"><tr><td>
...
<TR>
<TD align="right" width="50%" class="myform" nowrag> Your Name:&nbsp;</TD>
