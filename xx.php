...
if ($language == "chinese")
{
print "<title>" .  $City . " Chinese " .  $Titledesc . " Lawyers Attorneys Chinese Speaking Lawyers</title>";
...
if (file_exists($filename)) 
{
   echo "<p style=\"letter-spacing: 1px; margin-top: 10px\"><a href=\"$filename?thelisting=$Listingno&Passcity=$Passcity\" style=\"font-size: 14px; color: #152560;\"><B>$litinfo</b></a>";
}
else
    {
        echo "<p style=\"letter-spacing: 1px; margin-top: 10px\"><a href=\"showind.php?thelisting=$Listingno&Passcity=$Passcity\" style=\"font-size: 14px; color: #152560;\"><B>$litinfo</b></a>";
    }
