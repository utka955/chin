...
$spacer = "nbsp;";
 ...
 print "<br>Cityx=" . $Cityx;
 print "<br>statesh=" . $statesh;
...
if (file_exists($filename)) 
{
   echo "</p style=\"letter-spacing: 1px\"><a href=\"$filename?thelisting=$Listingno&Passcity=$Passcity&Cityz=$passcity&language=$language\" style=\"font-size: 14px; color: #152560\"><B>$litinfo</b></a>";
    ...
    {
        echo "</p style=\"letter-spacing: 1px\"><a href=\"showind.php?thelisting=$Listingno&Passcity=$Passcity&Cityz=$passcity&language=$language\" 
