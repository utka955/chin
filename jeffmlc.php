...
//  echo $_REQUEST["txtName"];
  ...
  echo "<h1 style=\"text-align: center\">The security code is invalid. Try again!</h1>";
exit();
}
...
//$emailSent = mail($recy, $subject, $msg_body, $header_info);
...
$showname = "Chinese Lawyers Network";
 ...
 echo "<br><h3 style=\"font-size: 16px; text-align: center\"><font color=red>Your email has been sent to $showname  </font></h3>";
